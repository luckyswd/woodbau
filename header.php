...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.css?v=1.0.0">
    ...
    <script>
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-5ZSQC5X');
    </script>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5ZSQC5X" height="0" width="0" style="display:none;visibility:hidden"></iframe>
    </noscript>
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1125926511475005&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
</head>
                    ...
                    <div class="col-md-2">
                        <div class="top-text">
                            <p><span>Salon wystawowy</span>
                                Kobylka, 05-230,<br> ul. Przyjacielska 37
                            </p>
                        </div>
                    </div>
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="top-lang">
                            <ul class="list-lang">
                                ...
                                <li><a href="https://woodbaupolska.pl/" title="woodbaupolska.pl" target="_top" class="active">PL</a></li>
                            ...
                            <div class="banner-slider owl-carousel owl-theme" id="owl-banner-slider">
                                ...
                                <?php foreach ($slider as $key => $value) { ?>
                                    <div class="banner-slider-item">
                                        ...
                                        <a href="<?php echo $value['code_category_slider_href']; ?>" class="btn btn-green">Cały katalog</a>
                                    </div>
                                <?php }; ?>
                            </div>
                            <script>
