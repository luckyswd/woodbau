...
$whatsappPhone = str_replace(array('(', ')', ' ', '-', '+'), '', $whatsapp['phone_number_wa']);
...
<footer>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo home_url(); ?>/platnosc/">Płatność</a>
                    </li>
                    <li>
                        <a href="<?php echo home_url(); ?>/delivery/">Dostawa</a>
                    </li>
                    <li>
                        <a href="<?php echo home_url(); ?>/sotrudnichestvo/">Współpraca</a>
                    </li>
                    <li>
                        <a href="<?php echo home_url(); ?>/lacznosc/">Kontakt</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-3">
                ...
                <div class="top-soc">
                    ...
                    <?php if (!empty($whatsapp['image'])) : ?>
                        <a href="https://api.whatsapp.com/send?phone=<?= $whatsappPhone ?>&app=facebook&entry_point=page_cta&fbclid=IwAR3g-Ur9AkIT893jD1skJT8JQXQKTGMFqY3ihfP5mR6JmJaRrwyM3JbCosQ"
                           target="_blank">
                            <picture>
        ...
        <div class="row">
            <div class="col-md-10">
                <p>&copy; 2020—2023 woodbaupolska.pl / Wszelkie prawa zastrzeżone.</p>
            </div>
        </div>
    </div>
