            ...
            <?php if ($post_catalog->have_posts()) : ?><?php while ($post_catalog->have_posts()) : $post_catalog->the_post(); ?><?php $values = get_post_meta(get_the_ID()); ?><?php //dump($values); ?>
                <div class="col-md-3">
                    <div class="product-item">
                        <div class="product-item-img" style="background-image: url('<?php echo $values['_code_catalog_photo|code_catalog_photo_item|0|0|value']['0']; ?>')"></div>
                        <h4><?php the_title(); ?></h4>
                                            ...
                                            <?php if ($key <= 2) : ?>
                                                <div class="catalog-item__characteristic">
                                                    <?php if (!empty($characteristic['characteristic_name'])) : ?>
                                                        <p class="characteristic-name"><?= $characteristic['characteristic_name'] ?>:</p>
                                                    <?php endif; ?>
                ...
                <div class="category-slider owl-carousel owl-theme" id="owl-category-slider">
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/bani/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/xaberkub/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/stoly-iz-duba/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/pilomaterialy/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/tandyry-i-kazany/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/barbekyu/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/postrojki-iz-brusa/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/bannye-aksessuary-iz-dereva/#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                    <div class="category-item">
                        ...
                        <div class="category-text">
                            ...
                            <a href="<?php echo home_url(); ?>/categories/kemping-domiki//#products" class="btn btn-green">Więcej szczegółów</a>
                        </div>
                    </div>
                </div>
            </div>
